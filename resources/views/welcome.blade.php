...
<div class="min-h-screen flex flex-col relative">
    ...
    <header class="sticky-header py-4" id="stickyHeader">
        <div class="container mx-auto px-4 md:px-8 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <img src="{{ asset('img/man3pekanbaru.png') }}" alt="Sipenpus Logo" class="h-10 w-10">
    ...
    <section id="subject" class="py-20 bg-white">
        <div class="container mx-auto px-4 md:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4 md:gap-6 max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                @foreach (['Sejarah dan Sosial', 'Filsafat', 'Sains', 'Fiksi', 'Lihat lainnya..'] as $index => $subjek)
                    <div class="subject-card border-2 border-primary-200 rounded-xl w-36 h-36 md:w-40 md:h-40 flex items-center justify-center text-center text-primary-900 font-semibold hover:bg-primary-50 transition" data-aos="zoom-in" data-aos-delay="{{ 200 + ($index * 100) }}">
                        <div>
                            @if ($subjek === 'Sejarah dan Sosial')
                                <i class="fas fa-landmark text-2xl mb-3 text-primary-600"></i>
                            @elseif ($subjek === 'Filsafat')
    ...
    <footer id="contact" class="bg-gray-800 text-white py-16 px-6">
        ...
        <div class="container mx-auto mt-12 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
            <p>© {{ date('Y') }} Sipenpus - Perpustakaan Ismail Marzuki MAN 3 Kota Pekanbaru. All rights reserved.</p>
        </div>
    </footer>
</div>
